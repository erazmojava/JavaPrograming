...
public class Zadatak16 {
    public static void main(String[] args) {
        ...
        listaPersona.add(new Developer("Caco", "Mali", 18, "male", new Place(64000, "Ulica8", "Čapljina", "BiH"), 23, "Menadžer", 8, 1200));
        ...
        for (Object person : listaPersona) {
            if (person instanceof Student) {
                ...
                if (student.getSchool().getName().equals("Škola34") && student.getPlace().getCity().equals("Tuzla")) {
                    System.out.println("Škola34 u Tuzli; ");
                    System.out.println(student.getName() + " " + student.getSchool().getName() + " " + student.getPlace().getCity());
            ...
            if (person instanceof Developer) {
                ...
                if (person1.getName().charAt(0)=='C' && person1.getAge() < 22) {
                    System.out.println("Počinje sa C, manje od 22; ");
